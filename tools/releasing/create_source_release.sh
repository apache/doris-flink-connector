...
CLONE_DIR=${RELEASE_DIR}/doris-flink-connector-tmp-clone
...
rsync -a \
  ...
  --exclude ".travis.yml" \
  . doris-flink-connector-${RELEASE_VERSION}

tar czf ${RELEASE_DIR}/apache-doris-flink-connector-${RELEASE_VERSION}-src.tgz doris-flink-connector-${RELEASE_VERSION}
gpg --armor --detach-sign ${RELEASE_DIR}/apache-doris-flink-connector-${RELEASE_VERSION}-src.tgz

cd ${RELEASE_DIR}
${SHASUM} apache-doris-flink-connector-${RELEASE_VERSION}-src.tgz > apache-doris-flink-connector-${RELEASE_VERSION}-src.tgz.sha512
