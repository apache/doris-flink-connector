...
public class LookupJoinCdcExample {
    public static void main(String[] args) throws Exception {
        ...
        tEnv.executeSql(
                "CREATE TABLE mysql_tb (id INT,name STRING,process_time as proctime(),primary key(id) NOT ENFORCED) WITH (\n"
                        + "  'connector' = 'mysql-cdc',\n"
                        + "  'hostname' = '127.0.0.1',\n"
                        + "  'port' = '3306',\n"
                        + "  'username' = 'root',\n"
        ...
        tEnv.executeSql(
                "CREATE TABLE doris_tb (id INT,age INT,dt DATE,dtime TIMESTAMP,primary key(id) NOT ENFORCED) WITH (\n"
                        + "  'connector' = 'doris',\n"
