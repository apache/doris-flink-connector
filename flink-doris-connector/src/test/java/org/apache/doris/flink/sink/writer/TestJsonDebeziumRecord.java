...
import org.apache.doris.flink.sink.writer.serializer.JsonDebeziumRecord;
...
public class TestJsonDebeziumRecord extends TestJsonDebeziumSchemaSerializerBase {
    ...
    public void testSerializeUpdateBefore() throws IOException {
        ...
        DorisRecord dorisRecord = jsonDebeziumRecord.serialize2DorisRecord(record, recordRoot, op);
    ...
    public void testGetCdcTableIdentifier() throws Exception {
        ...
        String identifier = jsonDebeziumRecord.getCdcTableIdentifier(recordRoot);
        ...
        String identifierSchema =
                jsonDebeziumRecord.getCdcTableIdentifier(objectMapper.readTree(insertSchema));
        ...
        String ddlRes = jsonDebeziumRecord.getCdcTableIdentifier(objectMapper.readTree(ddl));
    ...
    public void testGetDorisTableIdentifier() throws Exception {
        ...
        jsonDebeziumRecord.setTableMapping(map);
        String identifier = jsonDebeziumRecord.getDorisTableIdentifier("test.dbo.t1");
        Assert.assertEquals("test.t1", identifier);

        identifier = jsonDebeziumRecord.getDorisTableIdentifier("test.t1");
        Assert.assertEquals("test.t1", identifier);
