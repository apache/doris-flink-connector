...
public class DorisFlightSourceSplit implements SourceSplit {
    private String id;
    ...
    public DorisFlightSourceSplit(String id, PartitionDefinition partitionDefinition) {
        this.id = id;
    ...
    public String toString() {
        return String.format(
                "DorisSourceSplit: %s.%s.%s,be=%s,tablets=%s",
                id,
    ...
    public boolean equals(Object o) {
        ...
        DorisFlightSourceSplit that = (DorisFlightSourceSplit) o;
