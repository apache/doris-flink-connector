...
/** A serializer for the {@link DorisFlightSourceSplit}. */
public class DorisFlightSourceSplitSerializer
        implements SimpleVersionedSerializer<DorisFlightSourceSplit> {

    public static final DorisFlightSourceSplitSerializer INSTANCE =
            new DorisFlightSourceSplitSerializer();
    ...
    @Override
    public byte[] serialize(DorisFlightSourceSplit split) throws IOException {
    ...
    @Override
    public DorisFlightSourceSplit deserialize(int version, byte[] serialized) throws IOException {
        switch (version) {
            case 1:
            case 2:
    ...
    private DorisFlightSourceSplit deserializeSplit(int version, byte[] serialized)
            throws IOException {
        ...
        return new DorisFlightSourceSplit(splitId, partDef);
    }
}
