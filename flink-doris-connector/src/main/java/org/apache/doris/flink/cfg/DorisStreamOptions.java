...
public class DorisStreamOptions implements Serializable {
    ...
    private void init() {
        ...
        DorisReadOptions.Builder readOptionsBuilder = DorisReadOptions.builder()
                .setDeserializeArrowAsync(Boolean.valueOf(
                        prop.getProperty(ConfigurationOptions.DORIS_DESERIALIZE_ARROW_ASYNC,
                                ConfigurationOptions.DORIS_DESERIALIZE_ARROW_ASYNC_DEFAULT.toString())))
                .setDeserializeQueueSize(Integer.valueOf(
                        prop.getProperty(ConfigurationOptions.DORIS_DESERIALIZE_QUEUE_SIZE,
                ...
                .setRequestQueryTimeoutS(Integer.valueOf(
                        prop.getProperty(ConfigurationOptions.DORIS_REQUEST_QUERY_TIMEOUT_S,
                ...
                .setRequestConnectTimeoutMs(Integer.valueOf(
                        prop.getProperty(ConfigurationOptions.DORIS_REQUEST_CONNECT_TIMEOUT_MS,
                                ConfigurationOptions.DORIS_REQUEST_CONNECT_TIMEOUT_MS_DEFAULT.toString())))
                .setRequestReadTimeoutMs(Integer.valueOf(
                        prop.getProperty(ConfigurationOptions.DORIS_REQUEST_READ_TIMEOUT_MS,
