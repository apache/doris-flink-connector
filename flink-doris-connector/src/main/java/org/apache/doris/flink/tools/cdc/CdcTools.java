...
public class CdcTools {
    ...
    private static void createMongoDBSyncDatabase(String[] opArgs) throws Exception {
        ...
        Map<String, String> MongoDBMap = getConfigMap(params, "mongodb-conf");
        Configuration MongoDBConfig = Configuration.fromMap(MongoDBMap);
        DatabaseSync databaseSync = new MysqlDatabaseSync();
        syncDatabase(params, databaseSync, MongoDBConfig, "MongoDB");
    }
