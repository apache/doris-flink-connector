...
public class DorisStreamLoad implements Serializable {
    ...
    public void abortPreCommit(String labelSuffix, long chkID) throws Exception {
        ...
        while (true) {
            try {
                // TODO: Modify it according to label abort txn.
                //  Currently, it can only be aborted based on txnid, so we must first request a streamload based on the label to get the txnid.
